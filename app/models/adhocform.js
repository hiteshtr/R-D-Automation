...
var AdhocSchema = new Schema({
  ...
  phone_no: { type : String, default: '', validate:[validate.numericOrBlank,'Phone no. should be numeric.'] },
  email_id: { type : String, default:'', required:'Email ID is required.', unique:true, validate: [validate.email,'Invalid Email ID.'] },
  post_suggested: { type: Schema.ObjectId, ref: 'Designation', validate:[validate.empty,'post suggestion is required.'] },
