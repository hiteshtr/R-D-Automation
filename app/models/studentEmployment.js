...
var StudentSchema = new Schema({
  ...
  course_units: { type : String, default: '', validate:[validate.numeric,'Course units must be numeric.'] },
  thesis_units: { type : String, default: '', validate:[validate.numeric,'Thesis units must be numeric.'] },
